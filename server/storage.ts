...
export class DatabaseStorage implements IStorage {
  ...
  private async seedM1GhostRows(): Promise<void> {
    ...
    const rows: InsertM1IndicatorCatalog[] = [
      ...
      // === SECTION A — Prenatal core (page 1) ===
      // computeM1Values writes A-01a/A-01b (ANC ≥4, ≥8) by age group, the
      // BMI tuple A-02a/b/c, A-03 (Td2+), and A-04 (facility-based delivery).
      // Sit before the existing A-05..A-13 page-19 extras (rowOrder 105+).
      { templateVersionId: tplId, pageNumber: 1, sectionCode: "A",
        rowKey: "A-01a",
        officialLabel: "Women who gave birth with at least 4 ANC",
        dataType: "INT", rowOrder: 71, indentLevel: 0,
        columnGroupType: "AGE_GROUP", columnSpec: ageGroupSpec,
        isComputed: true, isRequired: true },
      { templateVersionId: tplId, pageNumber: 1, sectionCode: "A",
        rowKey: "A-01b",
        officialLabel: "Total women who delivered and completed at least 8 ANC",
        dataType: "INT", rowOrder: 72, indentLevel: 0,
        columnGroupType: "AGE_GROUP", columnSpec: ageGroupSpec,
        isComputed: true, isRequired: true },
      { templateVersionId: tplId, pageNumber: 1, sectionCode: "A",
        rowKey: "A-02a",
        officialLabel: "Pregnant women seen in first trimester with normal BMI",
        dataType: "INT", rowOrder: 73, indentLevel: 0,
        columnGroupType: "AGE_GROUP", columnSpec: ageGroupSpec,
        isComputed: true, isRequired: true },
      { templateVersionId: tplId, pageNumber: 1, sectionCode: "A",
        rowKey: "A-02b",
        officialLabel: "Pregnant women seen in first trimester with Low BMI",
        dataType: "INT", rowOrder: 74, indentLevel: 0,
        columnGroupType: "AGE_GROUP", columnSpec: ageGroupSpec,
        isComputed: true, isRequired: true },
      { templateVersionId: tplId, pageNumber: 1, sectionCode: "A",
        rowKey: "A-02c",
        officialLabel: "Pregnant women seen in first trimester with High BMI",
        dataType: "INT", rowOrder: 75, indentLevel: 0,
        columnGroupType: "AGE_GROUP", columnSpec: ageGroupSpec,
        isComputed: true, isRequired: true },
      { templateVersionId: tplId, pageNumber: 1, sectionCode: "A",
        rowKey: "A-03",
        officialLabel: "Women pregnant given at least 2 doses of Td (Td2+)",
        dataType: "INT", rowOrder: 76, indentLevel: 0,
        columnGroupType: "AGE_GROUP", columnSpec: ageGroupSpec,
        isComputed: true, isRequired: true },
      { templateVersionId: tplId, pageNumber: 1, sectionCode: "A",
        rowKey: "A-04",
        officialLabel: "Pregnant women who had facility-based delivery",
        dataType: "INT", rowOrder: 77, indentLevel: 0,
        columnGroupType: "AGE_GROUP", columnSpec: ageGroupSpec,
        isComputed: true, isRequired: true },
      ...
      // the existing aggregate a catalog home so it renders.
      ...
      // === SECTION D2 — Pentavalent + OPV (page 2) ===
      { templateVersionId: tplId, pageNumber: 2, sectionCode: "D2",
        rowKey: "D2-01", officialLabel: "DPT-HiB-HepB 1 (Penta 1)",
        dataType: "INT", rowOrder: 250, indentLevel: 0,
        columnGroupType: "SEX_RATE", columnSpec: sexRateSpec,
        isComputed: true, isRequired: true },
      { templateVersionId: tplId, pageNumber: 2, sectionCode: "D2",
        rowKey: "D2-02", officialLabel: "DPT-HiB-HepB 2 (Penta 2)",
        dataType: "INT", rowOrder: 251, indentLevel: 0,
        columnGroupType: "SEX_RATE", columnSpec: sexRateSpec,
        isComputed: true, isRequired: true },
      { templateVersionId: tplId, pageNumber: 2, sectionCode: "D2",
        rowKey: "D2-03", officialLabel: "DPT-HiB-HepB 3 (Penta 3)",
        dataType: "INT", rowOrder: 252, indentLevel: 0,
        columnGroupType: "SEX_RATE", columnSpec: sexRateSpec,
        isComputed: true, isRequired: true },
      { templateVersionId: tplId, pageNumber: 2, sectionCode: "D2",
        rowKey: "D2-04", officialLabel: "OPV 1",
        dataType: "INT", rowOrder: 253, indentLevel: 0,
        columnGroupType: "SEX_RATE", columnSpec: sexRateSpec,
        isComputed: true, isRequired: true },
      { templateVersionId: tplId, pageNumber: 2, sectionCode: "D2",
        rowKey: "D2-05", officialLabel: "OPV 2",
        dataType: "INT", rowOrder: 254, indentLevel: 0,
        columnGroupType: "SEX_RATE", columnSpec: sexRateSpec,
        isComputed: true, isRequired: true },
      { templateVersionId: tplId, pageNumber: 2, sectionCode: "D2",
