...
const DAILY_OPS_CHILDREN: NavItem[] = [
  ...
  {
    title: "PhilPEN",
    url: "/philpen-assessments",
    icon: HeartPulse,
    roles: rolesFor("/philpen-assessments"),
    activePrefixes: ["/philpen-assessments"],
  },
  {
    title: "Vision Screenings",
    url: "/vision-screenings",
    icon: Eye,
    roles: rolesFor("/vision-screenings"),
    activePrefixes: ["/vision-screenings"],
  },
  {
    title: "Cervical Cancer",
    url: "/cervical-cancer-screenings",
    icon: Ribbon,
    roles: rolesFor("/cervical-cancer-screenings"),
    activePrefixes: ["/cervical-cancer-screenings"],
  },
  {
    title: "Mental Health",
    url: "/mental-health-screenings",
    icon: Brain,
    roles: rolesFor("/mental-health-screenings"),
    activePrefixes: ["/mental-health-screenings"],
  },
  {
    title: "Oral Health",
    url: "/oral-health",
...
const PATIENT_CHILDREN: NavItem[] = [
  {
    ...
    activePrefixes: ["/prenatal", "/mother", "/fp", "/pnc", "/birth-attendance", "/prenatal-screenings"],
  },
  {
    title: "Children",
    url: "/child",
